...
- Windows 환경에서 ChatGPT 로그인 시작 시 로그인용 CMD 창을 띄워 인증 진행 가능하게 처리
...
- 권한/샌드박스 선택을 설정 메뉴 내부뿐 아니라 Codex 패널 하단에서 항상 보이게 노출

-------------------------------------------------
[추가 요청 - 2026-02-27]

- 모델 선택 드롭다운을 GPT-5.3/5.2/5.1 계열 Codex 옵션 목록으로 확장
